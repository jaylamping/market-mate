...
export function AgentConfiguration(){
 ...
 {save.isPending&&<p role="status" className="text-sm text-muted-foreground">Saving configuration…</p>}
    <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">{([
      ...
      ["setup_model","Setup runner","Saved for the upcoming setup worker, which will check research and dataset readiness before handoff."],
      ["experiment_model","Experiment runner","Saved for the upcoming experiment worker. Automatic experiment execution is not active yet."],
