...
paths=['db/migrations/0072_setup_response_recovery.sql','db/fixtures/setup_response_recovery_probe.sql','backend/src/openrouter_request.rs', 'db/migrations/0071_market_data_setup_revisit.sql','db/fixtures/market_data_setup_revisit_probe.sql','backend/src/incubator_experiment.rs','db/migrations/0067_market_data_setup_refresh.sql','db/fixtures/wu63_market_data_setup_probe.sql','backend/src/market_data_connection.rs','backend/src/market_data_connection/tests.rs','backend/src/market_data_acquisition.rs','scripts/wu63_market_data_test.sh']
r={'work_unit':'WU-63','passed':True,'checks':['owner_account_review_required','historical_provider_check','private_credentials_no_status_leak','owner_request_idempotency','collection_pause','calendar_morning_refresh','holiday_and_preopen_skip','catchup_window','repeat_schedule_dedup','original_snapshot_preserved','paused_refresh_fence','archived_research_stops','restricted_roles','audit_chain','legacy_regressions','setup_revisit_on_connector_availability','revisit_download_to_diagnostic','revisit_pause_archive_fences','revisit_question_no_loop','concurrent_revisit_once','revisit_context_survives_clarification','revisit_respects_capacity_wait','revisit_owner_answer_to_completion','confirmed_setup_retry_once','retry_download_to_completion','retry_archive_and_budget_fences'],'source_sha256':{p:hashlib.sha256(pathlib.Path(p).read_bytes()).hexdigest() for p in paths},'live_provider_tested':False}
