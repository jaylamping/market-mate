...
SELECT jsonb_build_object('work_unit','WU-61','passed',true,'checks',jsonb_build_array('registered_entitlement_required','idempotent_import','shared_observation_identity','correction_preserves_original','panel_raw_consistency','restricted_runtime_role','pointer_only_snapshot','result_reference_only_audit','resolved_experiment_payload','immutable_result_retry','referenced_retention','shared_cache_cleanup','actual_source_and_derivative_purge','source_tombstone','unrelated_experiment_preserved','replay_unavailable','audit_chain'));
ROLLBACK;
